                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="progress">
                            <div className="role" role="progressbar" aria-valuenow="95" aria-valuemin="0"aria-valuemax="100" style={{width:'90%'}}>90</div>
                        </div>
                        ...
                        <div className="progress">
                            <div className="role" role="progressbar" aria-valuenow="95" aria-valuemin="0"aria-valuemax="100" style={{width:'80%'}}>80</div>
                        </div>
                    </div>

                    ...
                    <div className="col-md-4">
                        ...
                        <p>Talented in project management, team leadership and independent problem solving.
                          ...
                          <ul className="social  float-md-left float-lft">
                            <li> 
                                <a href="http://linkedin.com/in/babatunde-atijosan-b70b97207"><i class="fab fa-linkedin"></i></a>
                            </li>
                             <li>
                             ...
                             <li>
                                 <a href="https://www.instagram.com/drumzee_/"><i class="fab fa-instagram"></i></a>
                             </li>
                          </ul>
                    </div>
